...
# Voor Model2: vervang Model3 door Model2 en voeg p_base.Y_benz toe aan constructor
...
function evaluate_A(t_inf::Float64, moi::Float64,
    ...
    p_test = Model3.Parameters(
        ...
        # Model2: voeg p_base.Y_benz toe aan het einde
    ...
    try
        ...
        t_norm     = t_norm = 1.0 - exp(-max(0.0, t_max_benz - t_inf) / p_base.duration)
...
function run_optimization_A(p_initial;
    ...
    println("\nGrid search A M3 ($total combinaties) | biomassa vast = $FIXED_BIOMASSA_A | w_benz=$w_benz")
...
function run_pareto_A(p_initial;
                      n_weights::Int  = 11,
                      figname::String = "pareto_A_M3.png")
