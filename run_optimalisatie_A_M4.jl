...
import Main.Model4: run, Benzind, Pfind, Nind
...
const W_P_DEFAULT      = 0.005
const W_T_DEFAULT      = 0.005
...
function evaluate_A(t_inf::Float64, moi::Float64,
    ...
    p_test = Model4.Parameters(
        p_base.duration, biomass,
        p_base.alpha_syn, p_base.beta_deg, p_base.K_s, p_base.V_max, p_base.p_pref,
        p_base.tau, p_base.b_0, p_base.k_b,
        p_base.E_coli_cellDW, p_base.MW, p_base.h_release,
...
function run_optimization_A(p_initial;
    ...
    println("\nGrid search A M4 ($total combinaties) | biomassa vast = $FIXED_BIOMASSA_A | w_benz=$w_benz")
