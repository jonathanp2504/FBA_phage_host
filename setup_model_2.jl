# ============================================================
#  SETUP MODEL 2
#  Laadt parameters, FBA en dFBA van model 2 en maakt een
#  standaard Parameters object p aan voor gebruik in kalibratie
#  en optimalisatie.
#
#  Gebruik:
#    include("setup_model_2.jl")
#    include("calibrate_refs.jl")        # kalibratie referentiewaarden
...
println("Model 2 setup voltooid — p aangemaakt")
