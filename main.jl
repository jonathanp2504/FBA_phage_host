...
b = 170.0          # Burst size
alfa_ads = 0  # Adsorptieconstante (L/gDW/h)
p_pref = [0.8925, 0.08925, 0.01825] # Voorkeurshiërarchie uit thesis
V_max = [15.0, 13.0, 4.0]           # Opnamesnelheden

include("./parameters.jl")
parameters::Parameters = Parameters(alpha_syn, beta_deg, K_s, tau, b, alfa_ads, p_pref, V_max,7,8,9,10,4:6,1:3)
include("./dFBA_function.jl")

# 5. INITIALISATIE
# [Glc, Mal, Ac, e_glc, e_mal, e_ac, S, I, L, P]
u0 = [8.0, 8.0, 0.0, 0.97, 0.01, 0.01, 1e6, 0.0, 0.0, 1000.0]
